...
/* Homepage */
$app->get("/", \trains\controllers\TrainController::class.':summaryDataSet');
/* Summary of specific day */
$app->get("/summary/{date}", \trains\controllers\TrainController::class.':summaryDataSet');
$app->get("/departures/{crs_code}", \trains\controllers\TrainController::class.':departureListAsTable');
...
$app->map(['GET', 'POST'],"/v1/summary/{date}", \trains\controllers\API::class.':summaryDataSetAPI');
